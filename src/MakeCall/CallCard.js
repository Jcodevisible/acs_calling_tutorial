...
import { LocalVideoStream, Features, CallClient } from '@azure/communication-calling';
...
export default class CallCard extends React.Component {
    ...
    async handleVideoOnOff() {
        try {
            //repro code
            //const callClientobj = new CallClient();
            //const deviceManagerObj = await callClientobj.getDeviceManager();
            //const cameras = await deviceManagerObj.getCameras()
            //repro code
